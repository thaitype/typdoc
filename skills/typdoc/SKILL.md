...
| Move or rename | `typdoc mv a.md b.md` rewrites every ref in this project that points at it, in frontmatter and body links, keeping each ref's written form | `git mv` or a file move leaves every ref pointing at the old name |
