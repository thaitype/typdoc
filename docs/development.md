...
This page is for working on typdoc rather than with it. `docs/design/design.md` is the source of
...
The binary lands in `target/debug/typdoc`. To install it for use instead, `README.md` has the
command.
...
- `docs/design/design.md` — what typdoc does and why, in full, and the arbiter when documents
  disagree.
- `docs/design/design-decision-phase-1/` and `.../design-decision-phase-2/` — the decisions behind
  the design, each with the research or the measurement it rests on, and a map naming what is
  still open.
- `README.md`, `docs/getting-started.md`, `docs/commands.md`, `docs/projects.md` — written for
