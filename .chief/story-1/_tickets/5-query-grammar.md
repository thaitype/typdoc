...
Decided with the human, 2026-09-19. The grammar is written into `docs/design.md`: a Grammar block in the Query section, plus the bullets Absence and negation, Values and escaping, Names and scope and Syntax that it refers to.
